...
namespace Lucaci_Andreea_Lab2.Data
{
    public class Lucaci_Andreea_Lab2Context : DbContext
    {
        ...
        public DbSet<Lucaci_Andreea_Lab2.Models.Author> Author { get; set; }

        public DbSet<Lucaci_Andreea_Lab2.Models.Member> Member { get; set; }

        public DbSet<Lucaci_Andreea_Lab2.Models.Borrowing> Borrowing { get; set; }
    }
}
